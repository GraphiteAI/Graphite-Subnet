...
import numpy as np
from graphite.protocol import GraphProblem, IsAlive, GraphSynapse
...
class TestProtocol(unittest.TestCase):
    ...
    def test_get_distance_matrix(self):
        ...
        problem = GraphProblem(n_nodes=3, nodes=[[0, 0], [3, 4], [6, 8]])
    ...
    def test_generate_edges(self):
        ...
        problem = GraphProblem(n_nodes=4, directed=True)
