...
INSTRUCTIONS FOR INSTALLATION: (Version 3.0.12 - October 2024)
-----------------------------

The software is available in gzipped tar format:

	LKH-3.0.12.tgz	(approximately 2.3 MB)

Download the software and execute the following UNIX commands:

  	tar xvfz LKH-3.0.12.tgz
   	cd LKH-3.0.12
	make

An executable file called LKH will now be available in the directory LKH-3.0.12.
...
Added code for solving the general colored traveling salesman problem(GCTSP) and
the colored capacitated colored traveling salesman problem (CCCTSP).
